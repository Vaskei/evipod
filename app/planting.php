      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer justify-content-center">
            <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="far fa-window-close"></i>&nbsp;&nbsp;Zatvori</button>
            <button type="submit" name="plantingDelete" id="plantingDelete" class="btn btn-danger"><i class="fas fa-trash-alt"></i>&nbsp;&nbsp;Obriši</button>
          </div>
        </div>
      </div>
    </div>
                    ...
                    <?php if ($resultUser['current_business_id'] != NULL) : ?>
                      <?php
                        ...
                        if ($resultFields->num_rows > 0) {
                          ...
                          echo "
                      <select class='form-control form-control-sm' name='' id='' required>
                        <option value='' selected disabled>Nema evidentiranih zemljišta.</option>
                      </select>";
                        }
                        ?>
                    <?php else : ?>
                      <select class="form-control form-control-sm" name="" id="" required>
                        <option value="" selected disabled>Nema aktivnog gospodarstva.</option>
                      </select>
                    <?php endif; ?>
                  </div>
                </div>
