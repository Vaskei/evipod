...
if (isset($_POST['careId'])) {
  ...
  if ($currentBusinessId != NULL) {
    $query = $conn->prepare("SELECT fields.field_name, fields.field_arkod, care.* FROM care INNER JOIN fields ON care.field_id = fields.field_id WHERE care.care_id = ? AND fields.business_id = ? LIMIT 1");
