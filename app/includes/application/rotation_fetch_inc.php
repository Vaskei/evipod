...
if (isset($_POST['rotationId'])) {
  ...
  if ($currentBusinessId != NULL) {
    $query = $conn->prepare("SELECT fields.field_name, fields.field_arkod, rotation.* FROM rotation INNER JOIN fields ON rotation.field_id = fields.field_id WHERE rotation.rotation_id = ? AND fields.business_id = ? LIMIT 1");
