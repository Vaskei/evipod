                    ...
                    <div class="card-body pb-0">
                        <div class="tab-content" id="myTabContentLoginReg">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="needs-validation" method="POST" action="./includes/login.php" novalidate>
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="loginEmail" name="loginEmail" placeholder="Unesite email..." required>
                                            <div class="invalid-feedback">Unesite potrebne podatke.</div>
                                        </div>
                                        <div class="form-group">
                                            <label for="loginPass">Lozinka</label>
                                            <input type="password" class="form-control" id="loginPass" name="loginPass" placeholder="Unesite lozinku..." required pattern="^[a-zA-Z0-9]{6,50}$">
                                            <div class="invalid-feedback">Unesite potrebne podatke.</div>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                                <img class="card-img-top" src="./images/afterglow-agriculture-back-light-512.jpg" alt="Photo by Felix Mittermeier from Pexels">
                                <div class="card-body">
                                    ...
                                    <form class="needs-validation" method="POST" action="./includes/registration.php" novalidate>
                                        <div class="form-group">
                                            ...
                                            <small id="registrationNameHelp" class="form-text text-muted">Min. 3, max. 100 znakova</small>
                                            <div class="invalid-feedback">Ime je obavezno (min. 3, max. 100 znakova).</div>
                                        </div>
                                        <div class="form-group">
                                            <label for="registrationEmail">Email</label>
                                            <input type="email" class="form-control" id="registrationEmail" name="registrationEmail" placeholder="Unesite email..." required>
                                            <small id="registrationEmailHelp" class="form-text text-muted">Potreban za aktivaciju računa i prijavu.</small>
                                            <div class="invalid-feedback">Email je obavezan i mora imati važeći format.</div>
                                        </div>
                                        <div class="form-group">
                                            <label for="registrationPass">Lozinka</label>
                                            <input type="password" class="form-control" id="registrationPass" name="registrationPass" placeholder="Unesite lozinku..." required pattern="^[a-zA-Z0-9]{6,50}$">
                                            <small id="registrationPassHelp" class="form-text text-muted">Slova i brojke, min. 6, max. 50 znakova</small>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" id="registrationPassConfirm" name="registrationPassConfirm" placeholder="Ponovite lozinku..." required pattern="^[a-zA-Z0-9]{6,50}$">
